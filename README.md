...
O template utilizado neste desafio está disponível na seguinte url: **[Acessar Template](https://github.com/Rocketseat/gostack-template-typeorm-upload)**

Antes de mais nada, navegue até a pasta do projeto e execute o comando `yarn` no seu terminal para instalar todas as dependências.
...
* **`should be able to delete a transaction`**: Para que esse teste passe, a aplicação deve permitir que a sua rota de delete exclua uma transação, e ao fazer a exclusão, ele retorne uma resposta vazia, com status 204.
